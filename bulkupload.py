...
def insert_snp_type(snp_id, indel, deletion, is_snp, monomorphic, transition, sv):
    try:
        cur.execute(
            'INSERT INTO "ngsdbview_snp_type" (snp_id, indel, deletion, is_snp, monomorphic, transition, sv) VALUES (%s, %s, %s, %s, %s, %s, %s)',
...
def insert_snp_results(snp_position, result_id, ref_base, alt_base, heterozygosity, quality, library_id, chromosome_id):
    ...
    try:
        ...
        if result_ids:
            ...
            if user_opt == 1:
                ...
                result_id = insert_result_option2(result_ids, library_id, genome_id, author_id, analysis_path)
                dbh.commit()
                return result_id
            elif user_opt == 3:
                notes = ''
...
def main():
    ...
    if num_of_files == 1:
        ...
        for each in vcf_reader:
            ...
            snp_id = insert_snp_results(position, result_id, ref_base, alt_base, heterozygosity, quality, library_id, chromosome_id)
